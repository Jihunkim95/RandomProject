...
namespace UI.Dates
{
    ...
    public class DatePicker : MonoBehaviour
    {
        ...
        private void _UpdateDisplay()
        {
            ...
            {
                Debug.Log("Updating Ref_DatePickerTransform height: " + Config.Sizing.PreferredHeight);
            ...
            foreach (var day in days)
            {
                ...
                if (dayType == DatePickerDayButtonType.OtherMonths && !Config.Misc.ShowDatesInOtherMonths)
                {
